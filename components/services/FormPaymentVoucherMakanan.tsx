...
const FormPaymentVoucherMakanan: FC = () => {
  ...
  return (
    <>
      {showConfirm && (
        <ModalConfirm
          label="Pembelian Voucher Game senilai"
      ...
      {showSuccess && (
        <ModalNotification
          label="Pembelian Voucher Game sebesar"
          nominal={"100.000"}
          logo={LogoSuccess}
          status="sukses"
        />
...
export default FormPaymentVoucherMakanan;
