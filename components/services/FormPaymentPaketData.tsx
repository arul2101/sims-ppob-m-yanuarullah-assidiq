...
const FormPaymentPaketData: FC = () => {
  ...
  return (
    <>
      {showConfirm && (
        <ModalConfirm
          label="Pembelian Paket Data senilai"
      ...
      {showSuccess && (
        <ModalNotification
          label="Pembelian Paket Data sebesar"
          nominal={"50.000"}
          logo={LogoSuccess}
          status="sukses"
        />
...
export default FormPaymentPaketData;
